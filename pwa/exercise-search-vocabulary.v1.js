...
(() => {
  ...
  globalThis.GymExerciseSearchVocabulary = deepFreeze({
  "schemaVersion": 1,
  "connectorTokens": [
    "в",
    "во",
  ...
  "aliasesByKey": {
    ...
    "incline_bench_press": [
      ...
      "жим штанги на верх грудей",
      "штанга на верх груди",
      "штанга на верх грудей"
    ],
    "incline_dumbbell_press": [
      ...
      "жим гантелей на верх грудей",
      "гантели на верх груди",
      "гантелі на верх грудей"
    ],
    "lat_pulldown": [
      "верхний блок",
      "верхній блок",
    ...
    "machine_lateral_raise": [
      ...
      "средняя дельта в тренажере",
      "махи у тренажері",
      "махи в сторони у тренажері",
      "середня дельта у тренажері",
      "machine lat raise",
    ...
    "overhead_dumbbell_triceps_extension": [
      ...
      "гантель за голову",
      "гантель на трицепс из за головы",
      "гантеля з за голови",
    ...
    "v_bar_pushdown": [
      "трицепс с треугольником",
      "треугольник на трицепс",
      "V ручка на трицепс",
      "трикутник на трицепс",
      "V bar pressdown",
      "triangle pushdown"
    ],
    "warm_up": [
