...
const appSource = readFileSync(new URL("../pwa/app.v64.js", import.meta.url), "utf8");
const stylesSource = readFileSync(new URL("../pwa/styles.v59.css", import.meta.url), "utf8");
const russianSource = readFileSync(new URL("../pwa/russian-text.v64.js", import.meta.url), "utf8");
