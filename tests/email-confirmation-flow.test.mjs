...
const appSource = readFileSync(new URL("../pwa/app.v52.js", import.meta.url), "utf8");
const stylesSource = readFileSync(new URL("../pwa/styles.v52.css", import.meta.url), "utf8");
const russianSource = readFileSync(new URL("../pwa/russian-text.v52.js", import.meta.url), "utf8");
