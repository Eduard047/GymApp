...
const appSource = readFileSync(new URL("../pwa/app.v68.js", import.meta.url), "utf8");
const stylesSource = readFileSync(new URL("../pwa/styles.v61.css", import.meta.url), "utf8");
const russianSource = readFileSync(new URL("../pwa/russian-text.v68.js", import.meta.url), "utf8");
