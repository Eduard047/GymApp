...
test("Android release metadata remains aligned with GymApp 3.2.7", () => {
  assert.match(
    gradleProperties,
...
test("Garmin, iOS, Android, and PWA remain aligned for 3.2.7", () => {
  assert.match(
    garminManifest,
