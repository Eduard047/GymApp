...
const expected = Object.freeze({
  marketingVersion: "3.2.4",
  androidVersionCode: "2000320902",
  iosBuildNumber: "38",
  garminVersion: "3.2.4",
...
test("Android release metadata remains aligned with GymApp 3.2.4", () => {
  assert.match(
    gradleProperties,
...
test("Garmin, iOS, Android, and PWA remain aligned for 3.2.4", () => {
  assert.match(
    garminManifest,
