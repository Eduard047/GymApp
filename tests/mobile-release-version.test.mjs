...
test("Android release metadata remains aligned with GymApp 3.1.2", () => {
  assert.match(
    gradleProperties,
...
test("Garmin, iOS, Android, and PWA remain aligned for 3.1.2", () => {
  assert.match(
    garminManifest,
