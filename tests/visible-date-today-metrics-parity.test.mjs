...
test("PWA date and Today helpers implement the shared localized, history-only contract", () => {
  ...
  assert.match(pwaServiceWorker, /CACHE_VERSION = "v140"/);
  assert.match(pwaServiceWorker, /"\.\/app\.v99\.js"/);
