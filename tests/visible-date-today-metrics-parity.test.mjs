...
test("PWA date and Today helpers implement the shared localized, history-only contract", () => {
  ...
  assert.match(pwaServiceWorker, /CACHE_VERSION = "v135"/);
  assert.match(pwaServiceWorker, /"\.\/app\.v97\.js"/);
