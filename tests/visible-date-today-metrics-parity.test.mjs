...
test("PWA date and Today helpers implement the shared localized, history-only contract", () => {
  ...
  assert.match(pwaServiceWorker, /CACHE_VERSION = "v143"/);
  assert.match(pwaServiceWorker, /"\.\/app\.v102\.js"/);
