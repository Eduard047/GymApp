...
test("root restores the installable first-party workout application", () => {
  ...
  assert.ok(scripts.includes("./app.v94.js"));
  ...
  assert.match(rootHtml, /styles\.v76\.css/);
...
test("active worker replaces the retirement worker without touching workout storage", () => {
  ...
  assert.match(workerSource, /CACHE_VERSION = "v131"/);
  assert.match(workerSource, /\.\/app\.v94\.js/);
