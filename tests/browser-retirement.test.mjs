...
test("root restores the installable first-party workout application", () => {
  ...
  assert.ok(scripts.includes("./app.v93.js"));
  ...
  assert.match(rootHtml, /styles\.v75\.css/);
...
test("active worker replaces the retirement worker without touching workout storage", () => {
  ...
  assert.match(workerSource, /CACHE_VERSION = "v130"/);
  assert.match(workerSource, /\.\/app\.v93\.js/);
