...
Status date: 2026-07-11. Apple changes requirements over time; recheck [Upcoming Requirements](https://developer.apple.com/news/upcoming-requirements/) and the current [App Review Guidelines](https://developer.apple.com/app-store/review/guidelines/) before every submission.
...
- [x] **Version/build:** current first-release values are `1.0.0` (`1`). Increment the build before a replacement upload and never reuse a processed build number.
