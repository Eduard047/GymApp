...
public enum MuscleMappingEngine {
    ...
    private static let exactMuscleMap: [String: [MuscleContribution]] = [
        ...
        "assisted dip": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "віджимання на брусах у гравітроні": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "отжимания на брусьях в гравитроне": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "підтягування з брусьями": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "підтягування з брусами": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "підтягування с брусьями": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "підтягування с брусами": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "подтягивания с брусьями": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
        "подтягивание с брусьями": muscles(("triceps", 0.85), ("chest", 0.75), ("shoulders", 0.35)),
